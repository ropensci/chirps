...
#> Warning in get_chirps.sf(tapajos, dates = c("2013-01-01", "2018-12-31")): dist is assumed to be in decimal degrees (arc_degrees)
...
```r
pi <- precip_indices(dat, timeseries = TRUE, intervals = 15)
